...
int main()
{
	//Point pt1(1,2);
	//Point pt2(2,4);
	func1("hello,world");//调用函数时发生了以下操作：
	//1、创建临时对象string("hello,world");
	//2、临时对象交给引用const string & str =string("hello,world");

	cout<<distance(Point(1,2),Point(3,4))<<endl;
